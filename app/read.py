...
#read_router.mount("/static", StaticFiles(directory="static"), name="static")



@read_router.get('/query_user', status_code=status.HTTP_200_OK)
async def Query_User():
    return datasystem


@read_router.get('/query_user/{user_id}', status_code=status.HTTP_202_ACCEPTED)
